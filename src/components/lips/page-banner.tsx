...
export default function PageBanner({
  ...
  return (
    <section className={`relative py-16 lg:py-24 bg-gradient-to-r ${gradient} text-white overflow-hidden`}>
      ...
      <div className="absolute top-10 left-10 w-24 h-24 border border-white/10 rotate-45 rounded-sm" />
      <div className="absolute bottom-8 right-16 w-16 h-16 border border-lips-gold/20 rotate-12 rounded-sm" />
