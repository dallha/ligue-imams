...
export const frPages: PageTranslations = {
  pages: {
    ...
    verify: { label: 'Vérification', title: 'Vérifier une Carte Membre', description: 'Saisissez le numéro de matricule figurant sur la carte membre pour vérifier instantanément sa validité. Le format est LIPS-ANNÉE-RÉGION-NUMÉRO.' },
  ...
  faq: {
    ...
    items: {
      ...
      q4: { q: "Comment vérifier une carte membre ?", a: "Rendez-vous sur la page 'Vérifier une Carte', saisissez le numéro de matricule (format LIPS-ANNÉE-RÉGION-NUMÉRO) et le système vérifiera instantanément sa validité." },
  ...
  verification: {
    ...
    verifyBtn: 'Vérifier',
    emptyError: 'Veuillez saisir un numéro de matricule', formatError: 'Format invalide. Utilisez le format LIPS-ANNÉE-RÉGION-NUMÉRO (ex: LIPS-2025-DKR-000124)', serverError: 'Erreur de connexion au serveur. Veuillez réessayer.',
    ...
    formatHint: 'Format : LIPS-ANNÉE-RÉGION-NUMÉRO',
  },
  dons: {
...
export const enPages: PageTranslations = {
  pages: {
    ...
    verify: { label: 'Verification', title: 'Verify a Member Card', description: 'Enter the registration number on the member card to instantly verify its validity. Format: LIPS-YEAR-REGION-NUMBER.' },
    ...
    memberLogin: {
      ...
      placeholder: 'email@example.sn or LIPS-2025-DKR-000124',
  ...
  faq: {
    ...
    items: {
      ...
      q4: { q: 'How to verify a member card?', a: 'Go to the "Verify a Card" page, enter the registration number (format: LIPS-YEAR-REGION-NUMBER) and the system will instantly verify its validity.' },
  ...
  verification: {
    ...
    verifyBtn: 'Verify',
    emptyError: 'Please enter a registration number', formatError: 'Invalid format. Use LIPS-YEAR-REGION-NUMBER format', serverError: 'Server connection error. Please try again.',
    ...
    formatHint: 'Format: LIPS-YEAR-REGION-NUMBER',
  },
  dons: {
